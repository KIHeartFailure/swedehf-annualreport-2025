...
axis(1,
  at = b[22] + (b[23] - b[22]) / 2,
  labels = "1-180 days follow-up", line = 6.7, tick = FALSE, cex.axis = cexmy, gap.axis = -10000000, las = 1
)
...
```
`{r} paste0("Sweden, all ", nrow(qiinfo) -3, " quality indicators ",  global_year)`
::::
