...
p <- tot %>%
  ...
  scale_y_continuous(breaks = seq(0, 160000, 10000), limits = c(0, 160000), labels = comma_format(), expand = c(0.05, 0.05)) +
...
`{r} paste0("Cumulative number of unique patients, 2003-", global_year)`
